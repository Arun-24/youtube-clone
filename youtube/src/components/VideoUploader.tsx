...
//   };
//   return (
//     <div className="bg-[color:var(--bg-surface)] rounded-lg p-6">
//       <h2 className="text-xl font-semibold mb-4">Upload a video</h2>

//       <div className="space-y-4">
//         {!videoFile ? (
//           <div
//             className="border-2 border-dashed border-[color:var(--border-color)]
...
const VideoUploader = ({ channelId, channelName }: any) => {
  ...
  return (
    <div className="bg-[color:var(--bg-surface)] text-[color:var(--text-primary)] rounded-lg p-6">
      <h2 className="text-xl font-semibold mb-4">Upload a video</h2>

      {!videoFile ? (
        <div
          className="
            border-2 border-dashed border-[color:var(--border-color)]
            rounded-lg p-8 text-center cursor-pointer
            hover:bg-gray-100 dark:hover:bg-gray-800 transition
          "
          onClick={() => fileInputRef.current?.click()}
        >
          <Upload className="w-12 h-12 mx-auto text-[color:var(--text-muted)] mb-2" />
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              className="mt-1 bg-transparent text-[color:var(--text-primary)]"
            />
          </div>
